This repository contains one R script called run_analysis.R that performs the data-merging, data-extraction, and data-averaging prescribed in the Coursera Getting and Cleaning Data MOOC.
